    ...
    <>
                        ...
                        <div key={stage}>
                          ...
                          <AnimatePresence initial={false}>
                            {isStageExpanded && (
                              ...
                              >
                                {stages[stage as "Summit" | "Temple"].map(
                                  (artist) => (
                                    <li key={artist.id}>
                                      <button
                                        onClick={() => {
      ...
      <style jsx global>{`
        ...
        aside::-webkit-scrollbar-track {
          background: #1a1a1a; /* dark steel groove */
        }

        aside::-webkit-scrollbar-thumb {
          background: linear-gradient(to bottom, #888, #aaa, #888); /* metallic grey gradient */
          border-radius: 8px;
          border: 1px solid #555; /* metal edge */
        }
