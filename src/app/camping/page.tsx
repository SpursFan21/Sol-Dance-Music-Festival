    ...
    <div>
      ...
      <div className="mx-auto p-8 text-center max-w-3xl">
        ...
        <div className="text-lg mb-4 space-y-4 text-left">
          <p>
            Car camping is available. Your vehicle will be parked adjacent to your designated camping space, with a 6–7 foot buffer between vehicles and 10–20 yards of clearance perpendicular for tents, pop-ups, or other camping setups.
          </p>
          <p>
            Quiet hours will be observed from 4:00 AM to 9:00 AM. We kindly ask that all campers respect their neighbors by keeping noise to a minimum during this period.
          </p>
          <p>
